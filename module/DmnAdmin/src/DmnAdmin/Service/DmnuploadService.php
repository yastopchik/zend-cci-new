...
class DmnuploadService
{
    ...
    public function getPrintOptionsByFormsId($formsid)
    {
        ...
        if (!is_null($formsid)) {
            switch ($formsid) {
                case 1:
                    $printOptions = $this->getServiceLocator()->get('print_options_ct1');
                    $this->setFileName('maket_ct1');
                    break;
                case 2:
                    $printOptions = $this->getServiceLocator()->get('print_options_ct2ru');
                    $this->setFileName('maket_ct2ru');
                    break;
                case 3:
                    $printOptions = $this->getServiceLocator()->get('print_options_generalen');
                    $this->setFileName('maket_generalen');
                    break;
                case 4:
                    $printOptions = $this->getServiceLocator()->get('print_options_generalru');
                    $this->setFileName('maket_generalru');
                    break;
                case 5:
                    $printOptions = $this->getServiceLocator()->get('print_options_a');
                    $this->setFileName('maket_a');
                    break;
                case 6:
