$(function () {
    ...
    $("#requestlist_n").jqGrid({
        ...
        colModel: [{name: 'id', index: 'id', width: '3%', searchoptions: {sopt: ['eq']}},
            ...
            {name: 'numblank', index: 'numblank', width: '6%', searchoptions: {sopt: ['eq']}},
            ...
            { name: 'numdoplist', index: 'numdoplist', width: '5%',editable: false, search: false},
            ...
            {name: 'executor', index: 'executor',width: '9%', sortable: false ,
                stype: 'select',
                searchoptions: {
                    sopt: ['eq'],
                    dataUrl: 'getexecutors',
                    style: "width:98%",
                    buildSelect: function (data) {
                        var response = $.parseJSON(data);
                        var s = '<select>';
