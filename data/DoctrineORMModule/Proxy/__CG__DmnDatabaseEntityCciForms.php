 ...
 */
class CciForms extends \DmnDatabase\Entity\CciForms implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DmnDatabase\\Entity\\CciForms' . "\0" . 'id', '' . "\0" . 'DmnDatabase\\Entity\\CciForms' . "\0" . 'forms'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CciForms $proxy) {
